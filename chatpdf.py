...
class RAG:
    ...
    def chunking_ingestion(self, pdf_file_path: str):
        """
        Ingest a PDF file, split its contents, and store the embeddings in MongoDB Atlas.
        """
    ...
    def clear(self):
        ...
        self.retriever = None
        # If you want to clear the vector store as well, uncomment the following lines:
        # self.vector_store = None
        # Reinitialize the vector store if needed
        # self.__init__()
